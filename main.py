...
def Train(dataset, feature_r, recoder): #features of the last epoch
    ...
    for fs, labels in tqdm(dataset):
        ...
        loss_trigger = criterion(out[labels.shape[0]::], Target_labels) + loss_f * opt.a + Triggersl2norm * opt.b
...
if __name__ == '__main__':
    ...
    np.save(opt.logpath + 'train_sub_idxs.npy', gtsrb_train_sub_idxs)
    np.save(opt.logpath + 'test_sub_idxs.npy', gtsrb_test_sub_idxs)
